...
export default defineComponent({
  ...
  components: {},
  methods: {
    scrollToAnchorPoint(refName: string) {
...
q-page
  ...
  //- Section A
  .row.q-pa-md
    .h2_title.text-white SECTION A – PRELIMINARY
    .q-ma-md
      .p A. Please read the terms and conditions contained herein
        span.text-bold (“Terms and Conditions”)
        span &nbsp;carefully.
      .p B. These Terms and Conditions shall govern the relationship between the Token Holder and the Company and set out the rights of the Token Holder in respect of the Company, the Brand and the Council
      .p C. Accordingly, the Token Holder’s –
        .q-mx-md
          .p i) transfer, sale and disposal of Tokens;
          .p ii) participation in the Brand;
          .p iii) use of the Platform; and
          .p iv) use and enjoyment of any services offered by the Company and all matters ancillary thereto;
          .p shall be subject to these Terms and Conditions and, by acquiring a Token and/or by otherwise making use of the Platform and/or any other services of the Company, the Token Holder agrees and undertakes to be bound by these terms and conditions.
      .p D. You agree and acknowledge that you will not use the Tokens, the platforms and/or the services in respect of the Company, the Tokens and the Brand –
        .q-mx.md
          .p i) in a manner that violates any Applicable Law or regulation;
          .p ii) to fund terrorism or other criminal activity;
          .p iii) to circumvent any export restrictions or economic sanctions; and/or
          .p vi) to engage in unlawful money transfers, currency exchanges, or money laundering; and
          .p the Token Holder undertakes that it shall not use the Tokens, the platforms and/or the services of the Company if it is restricted or prohibited by any Applicable Law and/or regulation from doing so.
      .p E.&nbsp;
        span.text-bold It is specifically recorded that the Company shall (in its sole and absolute discretion) be entitled to change, update, amend and/or replace these Terms and Conditions from time to time. Any changes, updates, amendments and/or replacements of these Terms and Conditions shall be published on the Serum Website. It is the Token Holder’s responsibility to regularly visit the Serum Website and view the Terms and Conditions
        span.text-bold applicable as at the time and date in question. Should the Token Holder not accept the new Terms and Conditions applicable as at the time and date in question, then the Token Holder shall immediately cease its use of any and all products and/or services offered by the Company. Any continued use of the products and services offered by the Company (in particular, the use of the Tokens, the Platform and the Serum Website) shall constitute deemed acceptance of the Terms and Conditions applicable as at the time and date in question.
      .p F. Notwithstanding anything herein to the contrary, should the Company, for any reason whatsoever, be restricted by Applicable Law from (i) issuing Tokens and/or repurchasing Tokens via the Liquidity Pool in accordance with clause 6 below and/or (ii) allowing the Token Holder to use and/or enjoy the benefit of a Token (including, in particular, the use of any of the services offered by the Company and/or its service providers), then the Company shall do whatever may be necessary in order to comply with such Applicable Law. The Token Holder waives any claim which it may have against the Company for any loss and/or damage which it may suffer arising from such termination of service and/or other restriction which the Company may, in its sole discretion, deem necessary to comply with such Applicable Law.

  //- Section B
  .row.q-pa-md
    .h2_title.text-white SECTION B – STANDARD TERMS AND CONDITIONS OF USE

    .q-ma-md
      //- TABLE OF CONTENTS
      .h2_title.text-white TABLE OF CONTENTS
      .p.text-bold
        ul
          li
            a(@click='scrollToAnchorPoint("definitions")') INTERPRETATION AND DEFINITIONS
          li
            a(@click='scrollToAnchorPoint("tokens")') TOKENS
          li
            a(@click='scrollToAnchorPoint("brand")') THE BRAND
          li
            a(@click='scrollToAnchorPoint("powers")') POWERS OF THE COMPANY
          li
            a(@click='scrollToAnchorPoint("transparency")') TRANSPARENCY
          li
            a(@click='scrollToAnchorPoint("liquidity")') LIQUIDITY POOL AND TRADE OF TOKENS
          li
            a(@click='scrollToAnchorPoint("warranties")') WARRANTIES
          li
            a(@click='scrollToAnchorPoint("limitations")') LIMITATION OF LIABILITY AND INDEMNITY
          li
            a(@click='scrollToAnchorPoint("force")') FORCE MAJEURE
          li
            a(@click='scrollToAnchorPoint("confidentiality")') CONFIDENTIALITY
          li
            a(@click='scrollToAnchorPoint("breach")') BREACH AND TERMINATION
          li
            a(@click='scrollToAnchorPoint("law")') LAW AND JURISDICTION
          li
            a(@click='scrollToAnchorPoint("assignment")') ASSIGNMENT
          li
            a(@click='scrollToAnchorPoint("misc")') MISCELLANEOUS
